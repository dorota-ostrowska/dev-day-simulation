...
class WindFarmDashboard:
    ...
    def load_and_process_data(self):
        ...
        self.wind_farm_data['Estimated power'] = self.wind_farm_data.apply(
            lambda farm: self._calculate_turbine_power(
                farm['Current wind speed'], 
                farm['Overall capacity']
            ), 
            axis=1
        )
    ...
    def _calculate_country_statistics(self):
        ...
        return self.wind_farm_data.groupby('Country').agg({
    ...
    def _prepare_wind_farm_cards(self):
        ...
        for _, farm in self.wind_farm_data.iterrows():
            ...
            efficiency = (estimated_power / overall_capacity * 100) if overall_capacity > 0 else 0
    ...
    def _prepare_country_cards(self, country_stats):
        ...
        for country, stats in country_stats.items():
            ...
            capacity_factor = (estimated_power / overall_capacity * 100) if overall_capacity > 0 else 0
            ...
            country_card = {
                ...
                'performance_level': self._get_country_performance_level(capacity_factor),
    ...
    def _calculate_fleet_summary(self):
        ...
        fleet_efficiency = (total_generation / total_capacity * 100) if total_capacity > 0 else 0
        
        # Calculate environmental impact estimates
        co2_avoided_per_hour = total_generation * 0.82  # tons CO2 per MWh
        homes_powered = (total_generation * 1000) / 2.5  # Average home consumption 2.5 kW
    ...
    def _get_empty_dashboard_data(self):
        ...
        return {
            ...
            'country_performance': [],
            'fleet_summary': {
                'total_capacity': 0, 'total_generation': 0, 'fleet_efficiency': 0,
                'co2_avoided': 0, 'homes_powered': 0, 'progress_width': 0
            },
            'status_metrics': {
                'active_farms': 0, 'countries': 0, 'total_capacity': 0,
